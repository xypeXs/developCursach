...
import ru.rsatu.trade.service.controller.OfferControllerService;
...
public class OfferController {
    ...
    public Response getOfferById(@PathParam("id") Long offerId) {
        SupplierOfferResponseDto responseDto = offerControllerService.getOfferById(offerId);
        return Response.ok(responseDto).build();
    }
